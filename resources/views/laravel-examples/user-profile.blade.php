    ...
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            ...
            @if (session('successUpdateProfile'))
                <div class="m-3  alert alert-success alert-dismissible fade show" id="alert-success" role="alert">
                    <span class="alert-text text-white">
                    {{ session('successUpdateProfile') }}</span>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        <i class="fa fa-close" aria-hidden="true"></i>
                    </button>
                </div>
            ...
            <div class="mt-3  alert alert-primary alert-dismissible fade show" role="alert">
                <span class="alert-text text-white">
                {{$errors->updateProfile->first()}}</span>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                    <i class="fa fa-close" aria-hidden="true"></i>
                </button>
            </div>
            ...
            <div class="row gx-4  @error('photo', 'updateProfile')border border-danger rounded-3 pt-2 @enderror">

                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img id="photoProfile" src="{{ auth()->user()->photo }}" onerror="this.onerror=null;this.src='{{ asset('assets/img/profile.png') }}';" alt="..." class="w-100 border-radius-lg shadow-sm">
                            ...
                            <input id="file-upload" type="file" style="display: none" onchange="loadFile(event)" accept="image/*" name="photo" form="updateProfileForm"/>
                    </div>
                </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('profile-update') }}" method="POST" role="form text-left" id="updateProfileForm" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('fullname', 'updateProfile')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->fullname }}" type="text" placeholder="Name" id="fullname" name="fullname">
                                    @error('fullname', 'updateProfile')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('username', 'updateProfile')border border-danger rounded-3 @enderror">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('email', 'updateProfile')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="email" placeholder="email" id="email" name="email" value="{{ auth()->user()->email }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('phone', 'updateProfile') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Location" id="phone" name="phone" value="{{ auth()->user()->phone }}">
...
<script>
    ...
    var output = document.getElementById('photoProfile');
