...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      @elseif (auth()->user()->user_type=="ketua")
        {{-- Sub User Akun --}}
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{__('common.user_managements')}}</h6>
        </li>
        <li class="nav-item">
      ...
      @elseif (auth()->user()->user_type=="bendahara")
        {{-- Sub kas--}}
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('penerimaan-kas') ? 'active' : '') }} " href="{{ url('penerimaan-kas') }}">
              ...
              <span class="nav-link-text ms-1">{{__('common.penerimaan_kas')}}</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('beban-beban') ? 'active' : '') }}" href="{{ url('beban-beban') }}">
            ...
            <span class="nav-link-text ms-1">{{__('common.beban_beban')}}</span>
          </a>
        </li>
      ...
      @elseif (auth()->user()->user_type=="sekretaris")
        {{-- Sub profile--}}
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }}" href="{{ url('user-profile') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            ...
            <span class="nav-link-text ms-1">{{__('common.user_management')}}</span>
          </a>
        </li>

        {{-- Sub akun--}}
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{__('common.akun')}}</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('profile') ? 'active' : '') }}" href="{{ url('profile') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">{{__('common.data_akun')}}</span>
          </a>
        </li>
      @endif
      {{-- <li class="nav-item">
